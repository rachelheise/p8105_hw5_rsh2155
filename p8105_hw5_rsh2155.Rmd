...
The greater the effect size, the greater the power will be because you are more easily able to correctly reject a false null hypothesis. In the plot above, we can see that as the population mean increases we are able to reject a greater proportions of the samples and conclude the population means are not equal to 0 with greater frequency.
